...
export class AIRouter {
  ...
  async callDirect(model: string, systemPrompt: string, userPrompt: string, online = false, signal?: AbortSignal): Promise<{ success: boolean; content: string; error?: string; usage?: any }> {
    try {
