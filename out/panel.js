...
class AIChainPanel {
    constructor(extensionUri, config, onTask, onOpenConfig, onSaveKey, onSaveConfig, onActivateLicense, onDeactivateLicense, isPro, lang = "en", licenseKey = "", spendingManager, hasApiKey = false, telemetryConsent = "ask") {
    ...
    validateAndApplyAgent(data, isEdit) {
        ...
        if (!data.model || (!/^[a-zA-Z0-9_\-]+\/[a-zA-Z0-9_\-\.]+$/.test(data.model) && data.model !== "openrouter/auto"))
