...
exports.CodeIndexStore = exports.extractHeaders = void 0;
const vscode = require("vscode");
const codeHeaders_1 = require("./codeHeaders");
Object.defineProperty(exports, "extractHeaders", { enumerable: true, get: function () { return codeHeaders_1.extractHeaders; } });
...
class CodeIndexStore {
    ...
    async getOrBuild(files, scanner) {
        ...
        for (const f of files) {
            ...
            if (content === null)
                continue;
            const fileHeaders = (0, codeHeaders_1.extractHeaders)(f.path, content);
    ...
    async verifyAndRefresh(filePath, freshContent) {
        await this.ensureLoaded();
        ...
        const fresh = (0, codeHeaders_1.extractHeaders)(filePath, freshContent);
        this.cache[filePath] = { mtime: cached?.mtime ?? Date.now(), headers: fresh };
        await this.save();
        return fresh;
    }
    async ensureLoaded() {
        if (this.loaded || !this.storageUri) {
            this.loaded = true;
            return;
        }
        try {
...
exports.CodeIndexStore = CodeIndexStore;
